...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    let homeAddress = trip.homeAddress ? trip.homeAddress.street + <br /> + trip.homeAddress.city + ', ' + i18n.t('countries:'+trip.homeAddress.country) : i18n.t('trips:not_applicable')
