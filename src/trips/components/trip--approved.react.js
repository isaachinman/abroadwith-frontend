...
module.exports = React.createClass({
  cancelTrip: function() {
    ...
    var success = function() {
      ...
      ga('send', 'event', 'booking_events', 'booking_cancelled_by_student')
  ...
  render: function() {
    ...
    var homeAddress = trip.homeAddress !== null ? trip.homeAddress.street + ', ' + trip.homeAddress.city + ', ' + i18n.t('countries:'+trip.homeAddress.country) : i18n.t('trips:not_applicable')
