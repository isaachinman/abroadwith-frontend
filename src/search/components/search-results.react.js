      ...
      <div className='row section white relative'>
        ...
        <div className='col s12 m12 l6'>
          <div className='search-result'>
            ...
            <div className="wallop">
              <div className="Wallop-list">
                <div className="Wallop-item Wallop-item--current"><img src="http://cdn.homedit.com/wp-content/uploads/2011/10/room-for-teens-girl-orange-picture.jpg"/></div>
                <div className="Wallop-item"><img src="http://lorempixel.com/800/400/food/2"/></div>
                <div className="Wallop-item"><img src="http://lorempixel.com/800/400/food/3"/></div>
                <div className="Wallop-item"><img src="http://lorempixel.com/800/400/food/4"/></div>
              </div>
            ...
            <div className='price'>
              <span>€400</span>
              <div className='course-added'>
                <i className="fa fa-map-marker"></i>15 courses
              </div>
            </div>
            <div className='info'>
              <div className='title'>
