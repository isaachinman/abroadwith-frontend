          ...
          <div className='manage-home-section'>
            ...
            <div className='row section'>
              ...
              <div className='col s10 m2 l2 input-field'>
                <select id='home-type' className='material' value={homeType} defaultValue=''>
              ...
              <div className='col s10 m3 l3 input-field'>
                <select id='safety' className='material' multiple value={safety} defaultValue={[]}>
              ...
              <div className='col s10 m4 l4 input-field'>
                ...
                <select id='amenities' className='material' multiple value={amenities} defaultValue={[]}>
            ...
            <div className='row section'>
              ...
              <div className='col s10 m2 l2 input-field'>
                <select id='meal-plan' className='material' multiple value={mealPlan} defaultValue={['breakfast']}>
              ...
              <div className='col s10 m3 l3 input-field'>
                <select id='food-option' className='material' multiple value={foodOption} defaultValue={[]}>
              ...
              <div className='col s10 m4 l4 input-field'>
                <select id='extras' className='material' multiple value={extras} defaultValue={[]}>
            ...
            <div className='row section'>
              ...
              <div className='col s8 m6 l8 input-field'>
                <select id='preferences' className='material' multiple value={preferences} defaultValue={[]}>
