  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <p class="expl">
						This is the Sitemap for <a href="https://www.abroadwith.com">Abroadwith</a>.
        </p>
        <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) > 0">
          ...
          <table cellpadding="3" id="sitemap">
            <thead><tr><th width="75%">Sitemap</th><th width="25%">Last Modified</th></tr></thead>
            <tbody>
              <xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
                <xsl:variable name="sitemapURL"><xsl:value-of select="sitemap:loc"/>
              </xsl:variable>
              <tr>
      ...
      <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
        ...
        <p class="expl">
          <a href="https://www.abroadwith.com/sitemap.xml">↑ Sitemap Index</a>
        </p>
        <table cellpadding="3" id="sitemap">
          <thead><tr><th width="75%">URL</th><th width="5%" title="Index Priority">Prio</th><!--<th width="5%">Images</th><th width="5%" title="Change Frequency">Ch. Freq.</th><th width="10%" title="Last Modification Time">Last Mod.</th>--></tr></thead>
          <tbody>
